...
func TestSolveDay04Part1(t *testing.T) {
	t.Run("Test SolveDay04Part1", func(t *testing.T) {
		got := SolveDay04Part1(`7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1
...
func TestSolveDay04Part2(t *testing.T) {
	t.Run("Test SolveDay04Part2", func(t *testing.T) {
		got := SolveDay04Part2(`7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1
